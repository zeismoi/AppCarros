...
public class FornecedoresActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Título
        getSupportActionBar().setTitle(R.string.fornecedores);
        //Adiciona o Fragment com o mesmo Bundle (args) da intent
        if (savedInstanceState == null){
            FornecedoresFragment frag = new FornecedoresFragment();
            frag.setArguments(getIntent().getExtras());
            getSupportFragmentManager().beginTransaction().add(R.id.containerFornecedores, frag).commit();
        }
