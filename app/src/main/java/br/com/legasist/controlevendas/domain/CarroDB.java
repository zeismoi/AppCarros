...
public class CarroDB extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("create table if not exists carro (_id integer primary key autoincrement, nome tex, desc text, url_foto text, " +
                "url_info text, url_video text, latitude text, longitude text, tipo text); ");
    ...
    //insere um novo carro, ou atualiza se existe
    public long save(Carro carro){
        ...
        try{
            ...
            if(id != 0){
                ...
                //update carros set values = ...where _id=?
    ...
    //Lê o cursor e cria a ista de carros
