...
public class AboutDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        aboutBody.append(Html.fromHtml(getString(br.com.legasist.controlevendas.R.string.about_dialog_text, versionName)));
        // Infla o layout
        LayoutInflater inflater = LayoutInflater.from(getActivity());
        TextView view = (TextView) inflater.inflate(br.com.legasist.controlevendas.R.layout.dialog_about, null);
        view.setText(aboutBody);
        view.setMovementMethod(new LinkMovementMethod());
        // Cria o dialog customizado
        return new AlertDialog.Builder(getActivity())
                .setTitle(br.com.legasist.controlevendas.R.string.about_dialog_title)
                .setView(view)
                .setPositiveButton(br.com.legasist.controlevendas.R.string.ok,
